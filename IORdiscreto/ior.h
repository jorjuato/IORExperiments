...
#define TRIAL_REPLICATION 		3
#define TRAIN_REPLICATION 		1
#define FALSE_TRIALS_PROPORTION 0
#define TRIAL_TRAIN_NUMBER		CTOA_MAX * CTD_MAX * TRIAL_TYPE_MAX * TRAIN_REPLICATION
#define DIMENSION 				CTOA_MAX * CTD_MAX * TRIAL_TYPE_MAX * (TRIAL_REPLICATION + TRAIN_REPLICATION)
								// 4 * 2 * 4 * (4 + 1) = 160
